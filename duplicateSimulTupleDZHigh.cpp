...
int main(int argc, char* argv[]) {
    ...
    TFile *simFile = new TFile(Form(dataDirectory + "SimulTupleDZHigh_%s.root", targetArr), 
                                    "READ");
    ...
    TFile *outputFile = new TFile(dataDirectory + Form("VecSumSimulDZHigh_%s.root", targetArr),
                                    "RECREATE");
    gROOT->cd();
