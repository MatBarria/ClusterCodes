...
int main(int argc, char* argv[]) {
    ...
    TFile *simFile = new TFile(Form(dataDirectory + "SimulTupleDZLow_%s.root", targetArr), 
                                    "READ");
    ...
    TFile *outputFile = new TFile(dataDirectory + Form("VecSumSimulDZLow_%s.root", targetArr),
                                    "RECREATE");
    gROOT->cd();
