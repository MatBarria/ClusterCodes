...
int main(int argc, char* argv[]) {
    ...
    TFile *simFile = new TFile(Form(dataDirectory + "SimulTupleTOFLow_%s.root", targetArr), 
                                    "READ");
    ...
    TFile *outputFile = new TFile(dataDirectory + Form("VecSumSimulTOFLow_%s.root", targetArr),
                                    "RECREATE");
    gROOT->cd();
