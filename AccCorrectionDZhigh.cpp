...
int main(int argc, char* argv[]) { 
    ...
    TFile* fileSimul  = new TFile(Form(dataDirectory "SimulTuple_%DZhigh.root", simulTarget),
                                         "READ");
    gROOT->cd();
    TFile* fileOutput = new TFile(dataDirectory + Form("Sys/DZhigh/corr_data_Phi_%i%i.root",
                                                        Q2Bin, NuBin), "RECREATE");
    gROOT->cd();
