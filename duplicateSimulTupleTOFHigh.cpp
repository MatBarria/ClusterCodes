...
int main(int argc, char* argv[]) {
    ...
    const TString outputDirectory = "/work/mbarrial/Data/";
    TFile *simFile = new TFile(Form(dataDirectory + "SimulTupleTOFHigh_%s.root", targetArr), 
                                    "READ");
    ...
    TFile *outputFile = new TFile(dataDirectory + Form("VecSumSimulTOFHigh_%s.root", targetArr),
                                    "RECREATE");
    gROOT->cd();
